...
public class BookDetailController implements Initializable {
    ...
    public void setData(int id){
        ...
        if(book != null){
            ...
            int init = quantitySpinner.getValueFactory().getValue();
            total.setText(init * Double.parseDouble(book.getPrice().toString()) + " VNĐ");
            total_price = init * Double.parseDouble(book.getPrice().toString());
